...
function [R, T, inliers, trialcount] = ransac(K, X, x, fittingfn, s, t, p, idsampl, maxTrials)
    ...
    if nargin < 7; p = 0.99; end % Desired probability of choosing at least one sample free from outliers
    if nargin < 8; idsampl = 1:npts; end;
    if nargin < 9; maxTrials = 1000000; end;
